...
class VisualGridHuntGame:
    """A flexible Pacman-style grid environment with support for traps, configurable opponents, and larger scales."""

    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None, custom_traps=None):
        self.width = width
        self.height = height
        ...
        while len(self.food_positions) < num_food:
            ...
            pos_tuple = (fx, fy)
            if pos_tuple != (0, 0) and pos_tuple not in self.walls and pos_tuple not in self.traps:
        ...
        while len(self.opponents) < num_opponents:
            ...
            if (tuple(op_pos) != (0, 0) and 
                ...
                tuple(op_pos) not in self.traps):
    ...
    def get_percept(self) -> dict:
        return {
            ...
            'on_trap': tuple(self.agent_pos) in self.traps,
    ...
    def execute_action(self, action: str):
        ...
        # Food check: update score and remove food
        if tuple_pos in self.food_positions:
            self.food_positions.remove(tuple_pos)
            self.score += 20

        # Opponent movement and collision check
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        # 4. Draw opponents (Dark Red Rectangles)
